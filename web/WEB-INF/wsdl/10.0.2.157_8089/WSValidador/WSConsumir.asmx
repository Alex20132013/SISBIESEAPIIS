...
<html>
    ...
    <head><link rel="alternate" type="text/xml" href="/WSValidador/WSConsumir.asmx?disco" />
  ...
  <body>
    ...
    <div id="content">
      ...
      <p class="heading1">WSConsumir</p><br>

      

      <span>

          <p class="intro">Las operaciones siguientes son compatibles. Para una definición formal, revise la <a href="WSConsumir.asmx?WSDL">descripción de servicios</a>. </p>
          
          
              <ul>
            
              <li>
                <a href="WSConsumir.asmx?op=Eliminar_validacion">Eliminar_validacion</a>
              ...
              <li>
                <a href="WSConsumir.asmx?op=Validando_usuario">Validando_usuario</a>
